...
class DepartmentControllerDeleteTest extends TestCase
{
    ...
    /** @test */
    public function delete_department_with_invalid_id()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/departments/100');
    ...
    /** @test */
    public function delete_department_without_token()
    {
        $response = $this->deleteJson('/api/v1/departments/1');
    ...
    /** @test */
    public function delete_department_with_correct_response()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
