...
class ProgramControllerDeleteTest extends TestCase
{
    ...
    /** @test */
    public function delete_program_with_invalid_id()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/programs/100');
    ...
    /** @test */
    public function delete_program_without_token()
    {
        $response = $this->deleteJson('/api/v1/programs/3');
    ...
    /** @test */
    public function delete_program_with_correct_response()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/programs/3');
