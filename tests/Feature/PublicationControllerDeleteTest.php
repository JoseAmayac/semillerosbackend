...
class PublicationControllerDeleteTest extends TestCase
{
    ...
    /** @test */
    public function delete_publication_with_invalid_id()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/publications/100');
    ...
    /** @test */
    public function delete_publication_without_token()
    {
        $response = $this->deleteJson('/api/v1/publications/2');
    ...
    /** @test */
    public function delete_publication_with_correct_response()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/publications/2');
