...
class UserControllerDeleteTest extends TestCase
{
    ...
    /** @test */
    public function delete_user_without_token()
    {
        $response = $this->deleteJson('/api/v1/users/6');
    ...
    /** @test */
    public function delete_user_with_correct_response()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/users/6');
