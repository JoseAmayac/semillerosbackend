...
class GroupControllerDeleteTest extends TestCase
{
    ...
    /** @test */
    public function delete_group_with_invalid_id()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/groups/100');
    ...
    /** @test */
    public function delete_group_without_token()
    {
        $response = $this->deleteJson('/api/v1/groups/4');
    ...
    /** @test */
    public function delete_group_with_correct_response()
    {
        $response = $this->withHeaders([
            'Authorization' => $this->token
        ])->deleteJson('/api/v1/groups/5');
